...
def evaluate(
    ...
    **kwargs,
    ...
    validator_metrics = Validator(gt, preds).compute_metrics()
    print("Validator Metrics:", validator_metrics)
    if use_wandb:
        wandb_metrics = {f"metrics/{k}": v for k, v in validator_metrics.items()}
    ...
    # Add F1 score to stats for use in solver
    stats["validator_metrics"] = validator_metrics
